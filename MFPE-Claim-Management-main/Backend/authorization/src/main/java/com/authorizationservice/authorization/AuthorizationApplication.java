...
public class AuthorizationApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		AuthenticationRequest user1 = new AuthenticationRequest("Maheshwar","mahe1234");
		AuthenticationRequest user2 = new AuthenticationRequest("Shristi","shri1234");
		AuthenticationRequest user3 = new AuthenticationRequest("Manogna","mano1234");
		AuthenticationRequest user4 = new AuthenticationRequest("Sravya","srav1234");
